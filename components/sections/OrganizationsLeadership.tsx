...
export function OrganizationsLeadership() {
  const organizations = [
    {
      id: "acm",
      name: "ACM Youth Chapter",
      role: "Founding Member & Tech Lead",
      description:
        "Established and led technical community for youth developers. Organized workshops, hackathons, and mentorship programs with 500+ members.",
      highlights: ["Community Building", "Technical Workshops", "Mentorship"],
      status: "active",
      impact: "500+",
      impactLabel: "Members Engaged",
    },
    {
      id: "startup",
      ...
      role: "Advisor & Mentor",
      description:
        "Advising early-stage startups on product strategy and technical architecture. Mentoring founders on AI integration and scaling challenges.",
      highlights: ["Product Strategy", "Mentoring", "Technical Advisory"],
      status: "active",
      impact: "15+",
      impactLabel: "Startups Advised",
    },
    {
      id: "education",
      ...
      description:
        "Designed and delivered STEM curriculum focused on AI and automation. Engaged 200+ students across multiple institutions.",
      highlights: ["Curriculum Design", "Education", "Public Speaking"],
      status: "active",
      impact: "200+",
